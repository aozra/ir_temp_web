    ...
    >
      ...
      >
        ...
        <el-form-item label="健康码" prop="hm">
          <el-input v-model="addfrom.hm"></el-input>
        </el-form-item>
        <el-form-item label="住址" prop="position">
          <el-input type="textarea" v-model="addfrom.position"></el-input>
        </el-form-item>
  ...
  methods: {
    ...
    addUser() {
      this.$refs.addfromRef.validate((valid) => {
        ...
        //可以发送起用户的网络请求
        this.axios
          .post("http://47.96.85.224:3000/user", this.addfrom)
          .then((response) => {
    ...
    getUserData() {
      this.axios.get("http://47.96.85.224:3000/user").then((response) => {
