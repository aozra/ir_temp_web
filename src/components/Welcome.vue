...
export default {
    ...
    methods: {
        drawLine1(){
            ...
            that.axios.get('http://47.97.251.68:3000/temp').then(res=>{
                ...
                that.temperatureData = res.data
                 ...
                 //日期可读化
                this.temperatureData.map(item=>item.createdAt = item.createdAt.slice(11,19))
        ...
        async getPeopleList1() {
            ...
            //   });
            this.temperatureData96 = this.temperatureData.filter(
                function(item) {
            ...
            //   });
                this.temperatureData120 = this.temperatureData.filter(
                        function(item) {
            ...
            //   });
                this.temperatureData144 = this.temperatureData.filter(
                    function(item) {
            ...
            //   });
                this.temperatureData168 = this.temperatureData.filter(
                    function(item) {
        ...
        async getPeopleList2(){
            ...
            //日期可读化
            this.tableData.map(item=>item.createdAt = item.createdAt.slice(11,19))
        ...
        updateTable(){
            ...
            //         that.tableData[0].temperature = that.temperature++
            //     },1000)
            // }
